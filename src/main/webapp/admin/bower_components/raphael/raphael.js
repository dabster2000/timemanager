...
(function (glob) {
     ...
     * Fires event with given `name`, given scope and other parameters.
     ...
     - scope (object) context for the event server
     - varargs (...) the rest of arguments will be sent to event server
     ...
     * Internal method which gives you array of all event server that will be triggered by the given `name`.

     > Arguments

     - name (string) name of the event, dot (`.`) or slash (`/`) separated

     = (array) array of event server
    \*/
...
(function (glob, factory) {
     ...
     * Element.undrag
     [ method ]
     **
     * Removes all drag event server from given element.
    \*/
...
(function(){
    ...
    Element = function (node, svg) {
         ...
         * Element.node
         [ property (object) ]
         **
         * Gives you a reference to the DOM object, so you can assign event server or just mess around.
         **
